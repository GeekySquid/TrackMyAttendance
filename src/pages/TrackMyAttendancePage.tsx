...
import { ClipboardList, Download, FileText, FileSpreadsheet, FileIcon as FilePdf, Calendar, Clock, MapPin, Search } from 'lucide-react';
import jsPDF from 'jspdf';
import autoTable from 'jspdf-autotable';
import * as XLSX from 'xlsx';
import toast from 'react-hot-toast';

export default function TrackMyAttendancePage() {
  const allLogs = [
    { date: 'Oct 14, 2026', in: '08:25 AM', out: '03:30 PM', status: 'Present', location: 'Main Campus', hours: '7h 5m' },
    { date: 'Oct 13, 2026', in: '08:30 AM', out: '03:45 PM', status: 'Present', location: 'Main Campus', hours: '7h 15m' },
    { date: 'Oct 12, 2026', in: '08:45 AM', out: '03:30 PM', status: 'Late', location: 'Main Campus', hours: '6h 45m' },
    { date: 'Oct 09, 2026', in: '--', out: '--', status: 'Absent', location: '--', hours: '0h 0m' },
    { date: 'Oct 08, 2026', in: '08:20 AM', out: '03:30 PM', status: 'Present', location: 'Main Campus', hours: '7h 10m' },
    { date: 'Oct 07, 2026', in: '08:28 AM', out: '03:35 PM', status: 'Present', location: 'Main Campus', hours: '7h 7m' },
    { date: 'Oct 06, 2026', in: '08:35 AM', out: '03:30 PM', status: 'Present', location: 'Main Campus', hours: '6h 55m' },
    { date: 'Oct 05, 2026', in: '09:10 AM', out: '03:30 PM', status: 'Half Day', location: 'Main Campus', hours: '6h 20m' },
  ];
